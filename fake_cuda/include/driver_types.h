...
typedef __device_builtin__ enum cudaStreamAttrID {
...
typedef __device_builtin__ union cudaStreamAttrValue {
...
typedef __device_builtin__ enum cudaKernelNodeAttrID {
  ...
  , cudaKernelNodeAttributePriority             = 8   /**< Sets the priority of the kernel. */
...
typedef __device_builtin__ union cudaKernelNodeAttrValue {
