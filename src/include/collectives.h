...
#define DECL5(func, algo, proto, devredop, type) \
  extern "C" void NCCL_FUNC_NAME(func, algo, proto, devredop, type)(); \
  extern "C" void NCCL_KERN_NAME(func, algo, proto, devredop, type)(struct ncclDevComm* comm, uint64_t channelMask, struct ncclWork* workHead); \
